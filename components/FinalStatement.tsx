  ...
  return (
    ...
    >
      ...
      <h2 className="font-display leading-[0.95]">
        <span className="final-line block text-[10.5vw] uppercase text-paper xs:text-[12vw] sm:text-[4vw]">
          Come Curious.
        </span>
        <span className="final-line mt-2 block text-[10.5vw] uppercase text-muted xs:mt-3 sm:mt-0 sm:text-[5vw]">
          Leave Connected.
        </span>
      </h2>
