...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      >
        STUDIO WYTES<sup className="text-[0.5em]">™</sup>
      </a>

      <div className="flex items-center gap-3 xs:gap-4 sm:gap-8">
        <div className="hidden flex-col items-end gap-0.5 sm:flex">
          <span className="font-meta text-[10px] text-crew-orange">
            The Crew
          </span>
        ...
        <a
          ...
          className="group inline-flex items-center gap-1.5 text-[10px] xs:text-[11px] sm:text-xs font-semibold tracking-[0.15em] uppercase text-ink bg-crew-orange px-3.5 py-2 xs:px-4 xs:py-2.5 sm:px-5 sm:py-3 hover:bg-paper transition-colors duration-300"
        >
          Apply
